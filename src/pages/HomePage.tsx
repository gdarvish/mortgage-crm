...
export default function HomePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSending(true);
    try {
      await fetch("https://formsubmit.co/ajax/habaithacalcali@gmail.com", {
        method: "POST",
        ...
        body: JSON.stringify({
          ...
          _subject: "פנייה חדשה מהאתר - הבית הכלכלי",
        }),
      });
      setSubmitted(true);
    } catch {
          ...
          <div className="md:w-1/2 p-10">
            {submitted ? (
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button type="submit" disabled={sending} className="w-full py-4 bg-brand-gold text-white rounded-lg font-bold text-lg hover:opacity-90 transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-60">
